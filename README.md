...
## 🛠️ Componentes de Laboratório

| Módulo | Descrição | Status de Empolgação |
| :--- | :--- | :--- |
| **Hyprland** | Onde a física das janelas acontece. Sem lag, apenas lógica. | 10.000.000.000% |
| **Waybar** | Uma barra de status tão limpa que faria um microscópio parecer sujo. | Absurdo |
| **Neovim** | Onde o código nasce. Se você usa VS Code, sinto muito pela sua alma. | Vital |

---

## 🚀 Protocolo de Instalação (Um passo de cada vez)

Se você é um colega de laboratório promissor, sabe o que fazer. Se for um habitante do neolítico digital, siga estas etapas antes que eu perca a paciência:
